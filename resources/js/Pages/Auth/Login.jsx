    ...
    return (
        <>
            ...
            <div className="flex min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-brand-secondary selection:text-white dark:bg-slate-950 dark:text-slate-100">
                ...
                <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#0A1628] via-[#16213E] to-[#0F2A3A] p-12 text-white flex-col justify-between relative overflow-hidden">
                    {/* Patrón de fondo abstracto */}
                    <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:24px_24px] pointer-events-none" />
                    
                    {/* Luces de acento */}
                    <div className="absolute -right-20 -top-20 h-80 w-80 rounded-full bg-brand-secondary/10 blur-3xl pointer-events-none" />
                    <div className="absolute -left-20 -bottom-20 h-80 w-80 rounded-full bg-brand-accent/10 blur-3xl pointer-events-none" />
                    ...
                    <div className="relative z-10 max-w-xl my-auto py-10">
                        ...
                        <div className="mt-8 relative rounded-3xl overflow-hidden bg-white/5 border border-white/10 p-2 shadow-2xl">
                            {!imgError ? (
                                ...
                                <div className="h-56 bg-gradient-to-br from-[#0A1628]/80 to-[#0F2A3A]/80 rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden">
                                    ...
                                    <div className="flex justify-between items-center border-b border-white/10 pb-3">
                                        <span className="text-[10px] font-bold text-brand-accent tracking-wider uppercase">INTELECTA CONSOLE</span>
                                        <span className="h-2 w-2 rounded-full bg-emerald-400 animate-pulse" />
                                    </div>
                                    <div className="flex-1 flex flex-col justify-center my-4">
                                        <div className="flex items-end justify-between h-24 px-4">
                                            <div className="w-8 bg-gradient-to-t from-brand-primary/60 to-brand-secondary rounded-t h-16" />
                                            <div className="w-8 bg-gradient-to-t from-brand-primary/60 to-brand-secondary rounded-t h-20" />
                                            <div className="w-8 bg-gradient-to-t from-brand-primary/60 to-brand-secondary rounded-t h-10" />
                                            <div className="w-8 bg-gradient-to-t from-brand-primary/60 to-brand-secondary rounded-t h-24" />
                                            <div className="w-8 bg-gradient-to-t from-brand-primary/60 to-brand-secondary rounded-t h-14" />
                                        </div>
                                    </div>
                                    <p className="text-[10px] text-slate-300">Consola de seguimiento predictivo y control académico.</p>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="relative z-10 grid grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-3 rounded-2xl border border-white/5 bg-white/5 p-4 backdrop-blur-sm">
                            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-brand-secondary/15 text-brand-accent shrink-0">
                                <Users className="h-5 w-5" />
                            </span>
                            <div>
                                <p className="text-xs font-bold text-white">Postulantes</p>
                                <p className="text-[10px] text-slate-300">Perfiles y procedencias</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 rounded-2xl border border-white/5 bg-white/5 p-4 backdrop-blur-sm">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-slate-300">Banco de reactivos</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 rounded-2xl border border-white/5 bg-white/5 p-4 backdrop-blur-sm">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-slate-300">Diseño estructurado</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3 rounded-2xl border border-white/5 bg-white/5 p-4 backdrop-blur-sm">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-slate-300">Seguimiento predictivo</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative flex w-full flex-col items-center justify-center p-6 sm:p-12 md:p-20 lg:w-1/2">
                    ...
                    <div className="w-full max-w-md">
                        ...
                        <div className="flex items-center gap-3 lg:hidden mb-8 justify-center">
                            <span className="flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-primary text-white shadow-lg shadow-brand-primary/20">
                                <GraduationCap className="h-6 w-6" />
                            </span>
                            <span className="bg-gradient-to-r from-slate-900 to-brand-primary bg-clip-text text-2xl font-black tracking-[0.15em] text-transparent dark:from-slate-100 dark:to-brand-accent">
                                INTELECTA
                            </span>
                        </div>
                            ...
                            <form onSubmit={submit} className="mt-8 space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="relative mt-1">
                                        ...
                                        <TextInput
                                            ...
                                            name="email"
                                            value={data.email}
                                            className="block w-full rounded-xl border-slate-200 bg-slate-50/50 pl-10 hover:border-slate-300 focus:border-brand-secondary focus:ring-brand-secondary/20 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
                                ...
                                <div className="flex items-center justify-between">
                                    <label className="flex items-center cursor-pointer select-none">
                                        <Checkbox
                                            ...
                                            className="rounded border-slate-300 text-brand-secondary focus:ring-brand-secondary dark:border-slate-600 dark:bg-slate-950"
                                        />
                                    ...
                                    {canResetPassword && (
                                        <Link
                                            ...
                                            className="text-xs font-bold text-brand-secondary hover:text-brand-secondary/80 hover:underline dark:text-brand-secondary dark:hover:text-brand-secondary/80"
                                        >
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className="w-full flex justify-center items-center gap-2 rounded-2xl bg-brand-primary py-3.5 text-sm font-bold text-white shadow-lg shadow-brand-primary/20 transition-all hover:bg-brand-primary/90 hover:shadow-brand-primary/30 hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50 disabled:pointer-events-none"
                                    >
